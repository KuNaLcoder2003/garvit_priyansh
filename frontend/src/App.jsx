...
const LandingPage = () => {
  ...
  return (
    // bg-gradient-to-b from-[#0f1729] to-black min-h-screen md:max-h-500px
    <>
      <div ref={heroRef} className="relative  flex flex-col gap-6 md:gap-8 justify-start overflow-hidden w-full">
