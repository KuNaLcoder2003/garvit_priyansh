...
export const MobileNav = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative z-50 mx-auto flex w-full max-w-[calc(100vw-2rem)]  flex-col items-center justify-between bg-white px-2 py-2 lg:hidden",
        visible && "bg-white/80 ",
        className
      )}>
      {children}
...
export const MobileNavToggle = ({
  ...
  return isOpen ? (
    <CrossIcon className="text-black relative -left-4" onClick={onClick} />
  ) : (
    <MenuIcon className="text-black relative -left-4" onClick={onClick} />
  );
};
