...
const HeroSection = ({ obj }) => {
  return (
    ...
    //       src={src}
    //       alt={`Icon ${idx + 1}`}
    //       className={`hidden lg:inline absolute w-6 md:w-8 ${idx === 0 ? 'top-2 left-1/4 md:left-36 md:top-4' :
    ...
    // </motion.div>
    <div
      className="w-screen h-screen bg-center bg-no-repeat bg-cover -mt-26"
