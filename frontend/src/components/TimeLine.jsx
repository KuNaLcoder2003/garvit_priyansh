  ...
  return (
    <div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-3xl font-bold text-slate-600 w-[50%] ">
          Our Debut India Tour
        </h2>
        <p
          className="text-neutral-700 text-sm md:text-base max-w-sm">
          We&apos;ve been working for our India Tour for the past 2 years. Here&apos;s
          a glimpse of our shows.
        </p>
      </div>
          ...
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <div
                ...
                <div
                  className="h-4 w-4 rounded-full bg-neutral-200  border border-neutral-300 " />
              </div>
              <h3
